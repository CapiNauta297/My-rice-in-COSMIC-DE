...
- Changed my desktop color from Cosmic Settings to a pure white (`#DFDFDF`) with a grey background (`#1F2324`). Btw, you can find my config [here](https://github.com/CapiNauta297/Dotfiles-epikos-tremendos/blob/main/escritorio.ron) (If you want to import it, just download the `.ron` file and import it in the settings)
